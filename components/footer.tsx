    ...
    <footer className="bg-background text-foreground py-12 border-t border-border">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-semibold mb-4 text-orange-500 font-serif">NAVIGATION</h4>
          ...
          {/* Social */}
          <div>
            <h4 className="font-semibold mb-4 text-orange-500 font-serif">SOCIAL</h4>
            <div className="flex space-x-4">
              <a
                href="https://instagram.com/jeremy"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-muted hover:bg-orange-500 rounded-full flex items-center justify-center text-foreground hover:text-white transition-colors duration-300"
              >
          ...
          <div>
            <h4 className="font-semibold mb-4 text-orange-500 font-serif">RECHTLICHES</h4>
            <ul className="space-y-2">
              <li>
                <a
                  href="#impressum"
